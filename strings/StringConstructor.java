...
public class StringConstructor {
    ...
    public static void main(String[] args) {
        ...
        //You cant print a value
        System.out.println(integers);

        //You can iterate and print the value of each integer
        for (int a:integers) {
        ...
        //This line will cause an issue because the array position started at 0
        //and the len of the array is going over the limits.
        //int offset = 1;
        int offset = 0;
